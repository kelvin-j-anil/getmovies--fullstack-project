        ...
        {selectedSeats.length > 0 && (
          <div className="mt-2 flex justify-center gap-2 items-center flex-col">
            ...
            {/* <StripeCheckout
              ...
              billingAddress
              stripeKey="pk_test_51OCvp2SCZfpt38TwBwhJmTUeLYDtTakQrhYmQK06HbhetYH5Nhmki9nNM7WhuPp8OOAYV8wNMW4rUhp3qCtCIynR00X3wdeYZL"
            >
              <Button title="Book Now" />
            </StripeCheckout> */}

            <Button title="Book Now" onClick={book}/>
